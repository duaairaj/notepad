...
import java.io.*;
import javax.swing.filechooser.*;//for filing data
    public class Notepad extends JFrame implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            }else if (ae.getActionCommand().equals("Exit")) {  //when user cclicke mouse to Exit
                System.exit(0);
            }else if (ae.getActionCommand().equals("Copy")) { // clik to copy
